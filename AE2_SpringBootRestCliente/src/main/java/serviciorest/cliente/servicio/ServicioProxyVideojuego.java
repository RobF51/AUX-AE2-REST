...
public class ServicioProxyVideojuego {
	...
	/**
	 * Método que obtiene un videojuego del servicio REST a partir de un id En caso de
	 * que el id no exita arrojaria una expcepción que se captura para sacar el
	 * codigo de respuesta
	 * 
	 * @param id que queremos obtener
	 * @return retorna el videojuego que estamos buscando, null en caso de que el
	 *         videojuego no se encuentre en el servidor (devuelva 404) o haya habido
	 *         algún otro error.
	 */
	public Videojuego obtener(int id) {
		try {
			...
			if (hs == HttpStatus.OK) {
				// Si el videojuego existe vendra en formato JSON en el body
		...
		} catch (HttpClientErrorException e) {// Errores 400
	...
	/**
	 * Método que da de alta un videojuego en el servicio REST
	 * 
	...
	public Videojuego alta(Videojuego v) {
		try {
			...
			// El segundo parametro el videojuego que ira en body
	 ...
	 * 
	 * @param v el videojuego que queremos modificar, se hara a partir del id por lo
	 *          que tiene que estar relleno.
	 * @return true en caso de que se haya podido modificar el videojuego. false en
	 *         caso contrario.
	 */
	 ...
	 * @return true en caso de que se haya podido borrar el videojuego. false en caso
	 *         contrario.
	 */
	public boolean borrar(int id) {
		try {
			...
			// Ej http://localhost:8080/videojuegos/1 DELETE
	...
	/**
	 * Metodo que devuelve todos los videojuegos o todos los videojuegos filtrados por
	 ...
	 * @return el listado de los videojuegos segun el parametro de entrada o null en
