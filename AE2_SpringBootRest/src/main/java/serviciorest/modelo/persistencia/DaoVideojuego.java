...
/**
 * Damos de alta un objeto que simula que los datos estan guardados en una BBDD trabajando con una lista
...
public class DaoVideojuego {
	 ...
	 * busqueda
	 * @return una lista con los juegos que coincidan en el nombre.
