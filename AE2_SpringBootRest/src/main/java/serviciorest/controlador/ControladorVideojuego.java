...
public class ControladorVideojuego {
	...
	// ControladorVideojuebo quedará perfectamente formado.
	...
	// "http://localhost:8080/videjouegos/ID" y el metodo a usar seria GET
	...
	// La URL para acceder a este metodo en caso de querer todos los videojuegos
	// sería:
	...
	// PUT
	// En este caso vamos a hacer una modificación de videojuego por ID
	...
	// La URL para acceder a este metodo sería:
	// "http://localhost:8080/videojuego/ID" y el metodo a usar seria PUT
	// Pasandole el videojuego sin el ID dentro del body del HTTP request
	...
	// DELETE
	// Aqui vamos a borrar una persona a traves de un ID que le pasemos en el
	// PATH.
